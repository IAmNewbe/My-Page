...
const News = () => {
  return (
    <div className="relative overflow-hidden">
      ...
      <img src={newsGradient1} alt="Gradient" className="absolute md:-left-6 top-0 animate-pulse -z-10" />
      <img src={newsGradient2} alt="Gradient" className="absolute md:-right-40 top-[1350px] animate-pulse -z-10" />
    </div>
  );
};
