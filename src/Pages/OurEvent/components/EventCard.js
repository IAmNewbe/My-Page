...
const EventCard = ({ first, second, third, description, image, linkDetails = "View More", link, active }) => {
  return (
        ...
        <div className="w-11/12 lg:w-10/12 flex flex-row justify-between items-center gap-x-5 z-20">
          ...
          <div className="md:pt-2 lg:pt-10 w-1/2 flex flex-col text-white gap-y-2 md:gap-y-4 lg:gap-y-12 items-start">
            ...
            {active 
              ? <a
                  href={link}
                  className="flex items-center text-[8.5px] md:text-base lg:text-lg hover:ring-2 hover:ring-white rounded-lg p-1"
                >
                  <p>{linkDetails}</p>
                  <span>
                    <MdChevronRight />
              ...
              : <a
                  href={link} onClick={ (e) => e.preventDefault()}
                  className="flex items-center text-[8.5px] md:text-base lg:text-lg cursor-default rounded-lg p-1"
                >
                  <p>{linkDetails}</p>
                  <span>
                    <MdChevronRight />
